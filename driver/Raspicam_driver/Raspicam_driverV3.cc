...
cout<<"comecando inicializacao"<<endl; 
cout<< tCamera.set(CV_CAP_PROP_FRAME_WIDTH,640)<<endl;
cout<<  tCamera.set(CV_CAP_PROP_FRAME_HEIGHT, 480)<<endl;
//  tCamera.set(CV_CAP_PROP_EXPOSURE,50);
 // tCamera.set(CV_CAP_PROP_GAIN,50);
cout<<  tCamera.set(CV_CAP_PROP_BRIGHTNESS,50)<<endl;
 // tCamera.set(CV_CAP_PROP_SATURATION,50);
cout<<  tCamera.set(CV_CAP_PROP_CONTRAST,50)<<endl;
cout<< tCamera.set(CV_CAP_PROP_SATURATION,50)<<endl;
cout<< tCamera.set(CV_CAP_PROP_GAIN,50)<<endl;
