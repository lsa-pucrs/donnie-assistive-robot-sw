...
PROCDEC	:	(('P'|'p')('R'|'r')('O'|'o')('C'|'c')('E'|'e')('D'|'d')('U'|'u')('R'|'r')('E'|'e'))
		;
		
// End procedure
ENDPROC	:	(('E'|'e')('N'|'n')('D'|'d')(' ')+('P'|'p')('R'|'r')('O'|'o')('C'|'c')('E'|'e')('D'|'d')('U'|'u')('R'|'r')('E'|'e'))
		;
...
// Speak -> GTTS speaks a string
SPEAKE	:	(('S'|'s')('P'|'p')('E'|'e')('A'|'a')('K'|'k'))
		;
		
// History -> Shows history of commands
HIST	:	(('H'|'h')('I'|'i')('S'|'s')('T'|'t')('O'|'o')('R'|'r')('Y'|'y'))
		;

// State -> Reports robot state
...
/* Ranger -> Front, Front Left, Front Right, Back, Back Left, Back Right */
RANGER	
...
/* Position */		
POS	:	(('P'|'p')('O'|'o')('S'|'s')(('I'|'i')('T'|'t')('I'|'i')('O'|'o')('N'|'n'))?) ((' ')+ (('X'|'x') | ('Y'|'y') | ('A'|'a')))?
		;

COLOR	:	(('C'|'c')('O'|'o')('L'|'l')('O'|'o')('R'|'r')) (' ')+ ((('B'|'b')('L'|'l')('U'|'u')('E'|'e')) | (('G'|'g')('R'|'r')('E'|'e')('N'|'n')) | (('R'|'r')('E'|'e')('D'|'d')))
		;

SOUND	:	(('S'|'s')('O'|'o')('U'|'u')('N'|'n')('D'|'d')) (' ')+ ((('O'|'o')('N'|'n')) | (('O'|'o')('F'|'f')('F'|'f')))
		;
...
REPTB	:	(('T'|'t')('I'|'i')('M'|'m')('E'|'e')('S'|'s'))
		;
		
ENDREPT	:	(('E'|'e')('N'|'n')('D'|'d')(' ')+('R'|'r')('E'|'e')('P'|'p')('E'|'e')('A'|'a')('T'|'t'))
		;
